...
// custom hooks: là những hooks do mình tự định nghĩa để thực hiện một logic nào đó, thường được sử dụng để chia sẽ logic giữa các component
// custom hooks phải được đặt tên theo format có từ khoá use ở đầu, VD: useCount, use...
